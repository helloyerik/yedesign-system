          ...
          >
            ...
            >
              ...
              <span
                ...
                class="mi-table__sort"
                :class="{
                  'is-asc': sortCol === column.id && sortDir === 'asc',
                  'is-desc': sortCol === column.id && sortDir === 'desc',
                }"
              >
                <svg
                  class="mi-table__sort-icon mi-table__sort-icon--up"
                  width="7"
                  height="13"
                  viewBox="0 0 7 13"
                  fill="none"
                ...
                <svg
                  class="mi-table__sort-icon mi-table__sort-icon--down"
                  width="7"
                  height="13"
                  viewBox="0 0 7 13"
                  fill="none"
...
.mi-table__sort.is-asc,
.mi-table__sort.is-desc {
  color: var(--mi-color-text-primary);
}

.mi-table__sort.is-asc .mi-table__sort-icon--down,
.mi-table__sort.is-desc .mi-table__sort-icon--up {
  display: none;
}
